...
char Names[1]; // The length prefixed names of files
} OMFFileIndex;
...
oldnsg arnsg[1]; // cSeg-1 structures exist for alloc text or comdat code
} oldsmd;
...
char reserved;
unsigned char cbName[1]; // length prefixed name of module
oldnsg32 arnsg[1]; // cSeg-1 structures exist for alloc text or comdat code
} oldsmd32;
