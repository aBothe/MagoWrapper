...
#define MAGO_FILEVERSION_STR    MAGO_MAKE_STRING( MAGO_VERSION_MAJOR.MAGO_VERSION_MINOR.MAGO_VERSION_BUILD.MAGO_VERSION_REVISION )
#define MAGO_PRODVERSION        MAGO_FILEVERSION
#define MAGO_PRODVERSION_STR    MAGO_MAKE_STRING( MAGO_VERSION_MAJOR.MAGO_VERSION_MINOR )
