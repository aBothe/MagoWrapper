...
extern const MIDL_SERVER_INFO MagoRemoteCmd_ServerInfo;

extern const RPC_DISPATCH_TABLE MagoRemoteCmd_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE MagoRemoteCmd___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x2497A4C6,0x7F4C,0x4383,{0x96,0x42,0x9B,0xCA,0xE2,0x83,0xD1,0xC3}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MagoRemoteCmd_v1_0_DispatchTable,
    0,
    0,
    0,
    &MagoRemoteCmd_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE MagoRemoteCmd_v1_0_s_ifspec = (RPC_IF_HANDLE)& MagoRemoteCmd___RpcServerInterface;
...
static const MIDL_STUB_DESC MagoRemoteCmd_StubDesc = 
    {
    (void *)& MagoRemoteCmd___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
...
static const RPC_DISPATCH_FUNCTION MagoRemoteCmd_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE MagoRemoteCmd_v1_0_DispatchTable = 
    {
    20,
    (RPC_DISPATCH_FUNCTION*)MagoRemoteCmd_table
    };

static const SERVER_ROUTINE MagoRemoteCmd_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)MagoRemoteCmd_Open,
    (SERVER_ROUTINE)MagoRemoteCmd_Close,
    (SERVER_ROUTINE)MagoRemoteCmd_Launch,
    (SERVER_ROUTINE)MagoRemoteCmd_Attach,
    (SERVER_ROUTINE)MagoRemoteCmd_Terminate,
    (SERVER_ROUTINE)MagoRemoteCmd_Detach,
    (SERVER_ROUTINE)MagoRemoteCmd_ResumeProcess,
    (SERVER_ROUTINE)MagoRemoteCmd_ReadMemory,
    (SERVER_ROUTINE)MagoRemoteCmd_WriteMemory,
    (SERVER_ROUTINE)MagoRemoteCmd_SetBreakpoint,
    (SERVER_ROUTINE)MagoRemoteCmd_RemoveBreakpoint,
    (SERVER_ROUTINE)MagoRemoteCmd_StepOut,
    (SERVER_ROUTINE)MagoRemoteCmd_StepInstruction,
    (SERVER_ROUTINE)MagoRemoteCmd_StepRange,
    (SERVER_ROUTINE)MagoRemoteCmd_Continue,
    (SERVER_ROUTINE)MagoRemoteCmd_Execute,
    (SERVER_ROUTINE)MagoRemoteCmd_AsyncBreak,
    (SERVER_ROUTINE)MagoRemoteCmd_GetThreadContext,
    (SERVER_ROUTINE)MagoRemoteCmd_SetThreadContext,
    (SERVER_ROUTINE)MagoRemoteCmd_GetPData
    };

static const MIDL_SERVER_INFO MagoRemoteCmd_ServerInfo = 
    {
    &MagoRemoteCmd_StubDesc,
    MagoRemoteCmd_ServerRoutineTable,
    MagoRemoteCmd__MIDL_ProcFormatString.Format,
    MagoRemoteCmd_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
