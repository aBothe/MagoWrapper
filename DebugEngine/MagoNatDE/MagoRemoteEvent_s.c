...
extern const MIDL_SERVER_INFO MagoRemoteEvent_ServerInfo;

extern const RPC_DISPATCH_TABLE MagoRemoteEvent_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE MagoRemoteEvent___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF5FECC74,0x6345,0x464A,{0xB4,0x79,0x74,0xF2,0x28,0x57,0x27,0x1C}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MagoRemoteEvent_v1_0_DispatchTable,
    0,
    0,
    0,
    &MagoRemoteEvent_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE MagoRemoteEvent_v1_0_s_ifspec = (RPC_IF_HANDLE)& MagoRemoteEvent___RpcServerInterface;
...
static const MIDL_STUB_DESC MagoRemoteEvent_StubDesc = 
    {
    (void *)& MagoRemoteEvent___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
...
static const RPC_DISPATCH_FUNCTION MagoRemoteEvent_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE MagoRemoteEvent_v1_0_DispatchTable = 
    {
    15,
    (RPC_DISPATCH_FUNCTION*)MagoRemoteEvent_table
    };

static const SERVER_ROUTINE MagoRemoteEvent_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)MagoRemoteEvent_Open,
    (SERVER_ROUTINE)MagoRemoteEvent_Close,
    (SERVER_ROUTINE)MagoRemoteEvent_OnProcessStart,
    (SERVER_ROUTINE)MagoRemoteEvent_OnProcessExit,
    (SERVER_ROUTINE)MagoRemoteEvent_OnThreadStart,
    (SERVER_ROUTINE)MagoRemoteEvent_OnThreadExit,
    (SERVER_ROUTINE)MagoRemoteEvent_OnModuleLoad,
    (SERVER_ROUTINE)MagoRemoteEvent_OnModuleUnload,
    (SERVER_ROUTINE)MagoRemoteEvent_OnOutputString,
    (SERVER_ROUTINE)MagoRemoteEvent_OnLoadComplete,
    (SERVER_ROUTINE)MagoRemoteEvent_OnException,
    (SERVER_ROUTINE)MagoRemoteEvent_OnBreakpoint,
    (SERVER_ROUTINE)MagoRemoteEvent_OnStepComplete,
    (SERVER_ROUTINE)MagoRemoteEvent_OnAsyncBreak,
    (SERVER_ROUTINE)MagoRemoteEvent_OnCallProbe
    };

static const MIDL_SERVER_INFO MagoRemoteEvent_ServerInfo = 
    {
    &MagoRemoteEvent_StubDesc,
    MagoRemoteEvent_ServerRoutineTable,
    MagoRemoteEvent__MIDL_ProcFormatString.Format,
    MagoRemoteEvent_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
