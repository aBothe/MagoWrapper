...
{
    DRuntime::DRuntime( DebuggerProxy* debugger, IProcess* coreProcess, int ptrSize )
        :   mDebugger( debugger ),
    ...
    HRESULT DRuntime::ReadBB( Address address, BB64& bb )
    {
        HRESULT hr = S_OK;
    ...
    HRESULT DRuntime::ReadTypeInfoStruct( Address addr, TypeInfo_Struct64& ti )
    {
        HRESULT hr = S_OK;
    ...
    HRESULT DRuntime::ReadAddress( Address baseAddr, uint64_t index, uint64_t& ptrValue )
    {
        HRESULT hr = S_OK;
    ...
    HRESULT DRuntime::ReadDArray( Address addr, DArray64& darray )
    {
        HRESULT hr = S_OK;
    ...
    HRESULT DRuntime::ReadThrowable( Address addr, Throwable64& throwable )
    {
        HRESULT hr = S_OK;
